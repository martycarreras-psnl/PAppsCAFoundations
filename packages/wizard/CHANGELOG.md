...
- 6d750dd: Remove connector binding from the setup wizard entirely. Connector selection was a
...
- Updated dependencies [6d750dd]
  - @pacaf/agent-instructions@3.9.0
  - @pacaf/scripts@4.0.2
...
- Updated dependencies [7b04569]
  - @pacaf/agent-instructions@3.8.3
...
- Updated dependencies [b390055]
  - @pacaf/agent-instructions@3.8.2
  - @pacaf/scripts@4.0.1
...
- d2950c1: The deployed Code App's landing page now shows a "fresh-eyes review" callout directly under the hero, above the two path cards. It recommends the opinionated workflow of starting a brand-new agent session to review the initial implementation against the plan (CONTEXT.md, dataverse/planning-payload.json, docs/adr) and the project's rules before functional testing, and includes a copyable handoff prompt for that review session.

## 3.4.8

### Patch Changes

- Updated dependencies [4bfebc2]
  - @pacaf/agent-instructions@3.8.1
...
- Updated dependencies [bb66ce0]
  - @pacaf/agent-instructions@3.5.7
